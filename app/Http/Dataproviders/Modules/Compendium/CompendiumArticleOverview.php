...
class CompendiumArticleOverview extends AbstractCardlist implements FilterableDataproviderInterface
{
    ...
    protected function getContent(Request $request): Builder
    {
        ...
        if ($player === null) {
            abort($this->respond(Response::HTTP_BAD_REQUEST, 'You are not a player in this campaign', Auth::user()->uuid));
        }
