...
class CsvHydratorV2 extends AbstractCsvHydrator
{
    protected function validate(array $data): bool
    {
        $validator = Validator::make($data, [
            ...
            'Tera_type' => ImportValidators::TERA_TYPE,
    ...
    private function importPokemon(StoredPokemon $pokemon, array $data, int $line): StoredPokemon
    {
        ...
        $pokemon->tera_type = ($data['Tera_type'] !== '') ? $data['Tera_type'] : $species->primary_type;
