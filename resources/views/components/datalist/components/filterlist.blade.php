...
<div id="{{$id}}-filterlist" class="dataprovider-filterlist">
    <div class="filter-container flex flex-row justify-center pt-2 gap-2">
        <button type="button" class="interactive pl-2" onclick="openFilterlist('{{$id}}', 'pksanc-box-cardlist-filter-modal', '{{route($route)}}')">
            Add Filter
        </button>
    </div>
</div>
